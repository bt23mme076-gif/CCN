        ...
        <div className="card max-w-3xl mx-auto space-y-6 text-sm sm:text-base leading-relaxed text-gray-700">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>To process payments through our payment gateway partner, Cashfree Payments</li>
          ...
          <div>
            ...
            <p>
              All payments are processed by Cashfree Payments, a licensed payment aggregator. We do
              not collect or store your card number, UPI PIN, or net-banking credentials on our
              servers — these are handled entirely by Cashfree's secure, PCI-DSS compliant systems.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              We do not sell your personal information. We share necessary details only with our
              payment gateway partner (Cashfree) to process transactions, and with our own
              operations team to activate and manage your subscription.
            </p>
          </div>
