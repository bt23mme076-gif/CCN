  ...
  useEffect(() => {
    ...
    if (typing) {
      if (displayed.length < full.length) {
        ...
        // Finished typing — pause 2s then erase
    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center px-4 py-8 overflow-y-auto"
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="w-full rounded-2xl p-5 text-center"
          ...
          <div className="rounded-xl p-4 min-h-[80px] flex flex-col items-center justify-center"
            style={{ background: 'rgba(255,255,255,0.05)', border: `1px solid ${MESSAGES[msgIndex].color}33` }}>
            <span className="text-2xl mb-2">{MESSAGES[msgIndex].icon}</span>
            <p className="text-base font-bold min-h-[28px]"
              style={{ color: MESSAGES[msgIndex].color }}>
              {displayed}
              {/* Blinking cursor */}
