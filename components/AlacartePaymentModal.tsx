...
export default function AlacartePaymentModal({
  isOpen,
  onClose,
  selectedChannelIds,
  channelCount,
      ...
      <div className="bg-white rounded-xl p-6 sm:p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
          <div className="flex justify-between text-sm sm:text-base">
            ...
            <span className="font-medium">A La Carte Subscription</span>
          </div>
          <div className="flex justify-between text-sm sm:text-base">
          ...
          <div className="flex justify-between text-base sm:text-lg font-bold pt-3 sm:pt-4 border-t">
            ...
            <span className="text-accent-red">{formatCurrency(totalPrice)}</span>
          </div>
        </div>
